    ...
    <div >
      ...
      >
        ...
        style={{
          ...
          <div className="px-3 py-1" style={{border:"10px solid #ffffff" , borderRadius:'26px',position:"absolute", top:"10%",right:"0",background: "linear-gradient(-201deg,  #FBBF66 20%, #F89603 80%)"
