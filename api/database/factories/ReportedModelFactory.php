...
class ReportedModelFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        $groupTitle = ["กลุ่มนี้เป็นกลุ่ม Spam","กลุ่มนี้มีการอนาจาร","กลุ่มนี้มีการล่วงละเมิดสิทธิ์","กลุ่มนี้มีการกระทำการก่อการร้าย","กลุ่มนี้มี Hate speech แสดงความเกลียดชัง","กลุ่มนี้มีเนื้อหาที่ไม่เหมาะสม","กลุ่มนี้มีการทำร้ายตัวเอง","กลุ่มนี้มีการใช้งานข้อมูลเท็จ"];
